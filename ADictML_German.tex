...
\input{ADictML_Glossary_German.tex}
...
\title {\vspace*{-10mm}
	{\Large {\bf Das {\fontsize{30}{35}\selectfont \textbf{\textsf{A\hspace*{0mm}''}}}\hspace*{-4mm}alto \\ Wörterbuch des Maschinellen Lernens}}  \\[-5mm] 
	% \small Comments are warmly welcome at \url{alex.jung@aalto.fi}.
}

\author{\small Dipl.-Ing.\ Dr.techn.\ Alexander Jung \\[-6mm]% <-this % stops a space
%\thanks{}
}
