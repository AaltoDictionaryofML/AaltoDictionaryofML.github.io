...
\title {\vspace*{10mm}
	{\huge {\bf The {\fontsize{40}{48}\selectfont \textbf{\textsf{A\hspace*{-2mm}''}}}\hspace*{-4mm}alto \\[-2mm] Dictionary of Machine Learning}}  \\[-2mm] 
		{\Large {\bf Course Edition CS-E4740 Federated Learning}}  \\[-5mm] 
...
\begin{center}
	\textbf{Aalto University publication series}\\[2mm]
	Science, Technology 1/2026
\end{center}

\vspace{10mm}

\noindent
ISBN 978-952-64-3014-0 (paperback)\\
ISBN 978-952-64-3013-3 (pdf)\\[2mm]
ISSN 1799-4896 (print)\\
ISSN 1799-490X (pdf)

\vspace{5mm}

\noindent
\url{https://urn.fi/URN:ISBN:978-952-64-3013-3}
