...
\newpage
\begin{align} 
		&\prob{\mathcal{A}} &\quad & \parbox{.85\textwidth}{The probability of the measurable event $\mathcal{A}$. 
		\\ See also: \gls{probability}.} \nonumber \\[2mm] \hline \nonumber\\[-5mm]
	&\prob{\featurevec;\weights} &\quad & \parbox{.85\textwidth}{A parameterized \gls{probdist} of an \gls{rv} $\featurevec$. 
		...
		\\ See also: \gls{probdist}, \gls{probmodel}, \gls{parameter}.} \nonumber \\[2mm] \hline \nonumber\\[-5mm]
	...
	&\mathcal{N}(\meanvecgeneric, \mathbf{C}) &\quad & \parbox{.85\textwidth}{The \gls{mvndist} of a \gls{vector}-valued 
		...
		\nonumber \\[2mm] \hline \nonumber\\[-5mm]
		&\Omega &\quad & \parbox{.85\textwidth}{A \gls{samplespace} of all possible outcomes of a random experiment. \\ See also: \gls{event}.}  \nonumber \\[2mm] \hline \nonumber\\[-5mm]
		&\mathcal{F} &\quad & \parbox{.85\textwidth}{A collection of \gls{measurable} subsets of a \gls{samplespace} $\Omega$. \\ See also: \gls{samplespace}, \gls{event}.}  \nonumber \\[2mm] \hline \nonumber\\[-5mm]
		...
		\\ See also: \gls{probdist}, \gls{samplespace}, \gls{measurable}.} \nonumber                                       
\end{align}
...
\begin{align}
	...
	&\nodedegree{\nodeidx} & \quad & \parbox{.80\textwidth}{The weighted node degree $\nodedegree{\nodeidx}\!\defeq\!\sum_{\nodeidx' \in \neighbourhood{\nodeidx}}\hspace*{-1mm} \edgeweight_{\nodeidx,\nodeidx'}$ 
		of node $\nodeidx$.
		\\ See also: \gls{graph}. }  \nonumber 
\end{align} 
