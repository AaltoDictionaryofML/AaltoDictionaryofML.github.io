...
\begin{align} 
	...
	&\va \geq \vb &\quad & \parbox{.85\textwidth}{Entry-wise inequality between \glspl{vector} 
		$\va,\vb \in \mathbb{R}^{\featuredim}$, i.e., $\mathbf{a}_{\featureidx} \geq \mathbf{b}_{\featureidx}$ 
