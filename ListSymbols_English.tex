...
\begin{align} 
	...
	&\featurevec\,^{T} &\quad & \parbox{.75\textwidth}{The \gls{transpose} of a \gls{matrix} that has the \gls{vector} 
...
\begin{align} 
	...
	&\va \geq \vb &\quad & \parbox{.85\textwidth}{Entry-wise inequality between 
	vectors $\va,\vb \in \mathbb{R}^{\featuredim}$, i.e.,
	$\mathbf{a}_{\featureidx} \geq \mathbf{b}_{\featureidx}$ 
