...
\newpage
\begin{align} 
	&\mgf{x}{t} &\quad & \parbox{.85\textwidth}{The 
	\gls{mgf} of a \gls{rv} $x$.
		\\ See also: \gls{probdist}, \gls{pdf}.} \nonumber \\[2mm] \hline \nonumber\\[-5mm]
	&\probdist^{(\dataset)} &\quad & \parbox{.85\textwidth}{The 
	\gls{empiricaldistribution} of a \gls{dataset} $\dataset$.
		\\ See also: \gls{bootstrap}, \gls{dataset}, \gls{empiricaldistribution}.} \nonumber \\[2mm] \hline \nonumber\\[-5mm]
