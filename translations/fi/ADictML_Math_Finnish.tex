...
\newglossaryentry{psd}
{name={positiivisesti semidefiniitti (psd)},
	description={A\index{positiivisesti semidefiniitti (psd)} (real-valued) 
	...
	first={positiivisesti semidefiniitti (psd)},
	type=math, 
	text={psd}  
}
...
{name={normaali matriisi},
	description={A square matrix $\mA \in \mathbb{C}^{\nrfeatures \times \nrfeatures}$ 
                 that commutes with its conjugate transpose, i.e., $\mA\mA^{H}=\mA^{H}\mA$. 
                 Normal matrices\index{normaali matriisi} admit an orthonormal basis of \glspl{eigenvector} and are 
                 unitarily \gls{diagonalizable}.},
	first={normaali matriisi},
    type=math, 
	plural={normaalit matriisit},
	firstplural={normaalit matriisit},
	text={normaali matriisi}
}

% Tilastotieteen sanasto
\newglossaryentry{spectraldecomp}
{name={spektrihajotelma},
	description={A \gls{evd} of a \gls{normalmatrix} is called a spectral decomposition \index{spektrihajotelma}. It has the special property that the \glspl{eigenvector} of the \gls{normalmatrix} are orthonormal. This also works the other way; any \gls{matrix} that has orthonormal \glspl{eigenvector} is a \gls{normalmatrix}.
		See also: \gls{evd}, \gls{normalmatrix}, \gls{eigenvector}. },
	first={spektrihajotelma},
	type=math,
	text={spektrihajotelma}
}

% Tieteen termipankki
\newglossaryentry{symmetricmatrix}
{name={symmetrinen matriisi},
	description={A square\index{symmetrinen matriisi} \gls{matrix} $\mA$ with real-valued 
                 entries that is equal to its transpose, i.e., $\mA=\mA^{T}$. Every 
                 symmetric \gls{matrix} is a \gls{normalmatrix}.},
	first={symmetrinen matriisi},
	plural={symmetriset matriisit},
    type=math,
	firstplural={symmetriset matriisit},
	text={symmetrinen matriisi}
}

% Tilastotieteen sanakirja, tieteen termipankki
\newglossaryentry{transpose}
{name={transpoosi},
 description={The transpose\index{transpoosi} of a real-valued \gls{matrix} is obtained by exchanging 
...
\newglossaryentry{hermitian}
 {name={hermiittinen matriisi},
 	description={A square\index{hermiittinen matriisi} matrix $\mA \in \mathbb{C}^{\nrfeatures \times \nrfeatures}$ is 
	             Hermitian if it coincides with its conjugate transpose, i.e., $\mA=\mA^{H}$. 
                 Trivally, a Hermitian matrix is also a \gls{normalmatrix}.},
 	first={hermiittinen matriisi},
	type=math, 
 	plural={hermiittiset matriisit},
 	firstplural={hermiittiset matriisit},
 	text={hermiittinen matriisi}
}

% tilastotieteen sanasto, tieteen termipankki
\newglossaryentry{dimension}
{name={ulottuvuus},
	description={The\index{ulottuvuus} dimension $\dim \mathcal{A}$ of a 
...
{name={lineaarisesti riippumaton},
	description={A subset $\{\va^{(1)}, \,\ldots, \,\va^{(\nrfeatures)}\} \in \mathcal{V}$ 
		of a \gls{vectorspace} is linearly independent\index{lineaarisesti riippumaton} 
	...
	text={lineaarisesti riippumaton}, 
	type=math,
	first={lineaarisesti riippumaton}  
}

% Tilastotieteen sanasto, TEPA, Tieeen termipankki
\newglossaryentry{basis}
{name={kanta},
	description={A basis\index{kanta} of a \gls{vectorspace} $\mathcal{V}$ 
...
{name={leveä matriisi},
	description={A\index{leveä matriisi} \gls{matrix} 
		...
		See also: \gls{matrix}. },
	text={leveä matriisi}, 
	firstplural={leveät matriisit}, 
	plural={leveät matriisit}, 
	type=math,
   	first={leveä matriisi} 
}

% Lähde: minä
\newglossaryentry{tallmatrix}
{name={korkea matriisi},
	description={A\index{korkea matriisi} \gls{matrix} $\featuremtx \in \mathbb{R}^{\samplesize \times \nrfeatures}$ 
	...
	text={korkea matriisi}, 
	firstplural={korkeat matriisit}, 
	plural={korkeat matriisit}, 
	type=math,
	first={korkea matriisi} 
}
...
\newglossaryentry{mgf}
{name={momenttiemäfunktio}, 
	description={Consider the\index{momenttiemäfunktio} MGF $\mgf{x}{t}$ 
 	...
 	first={momenttiemäfunktio}, 
 	firstplural={momenttiemäfunktiot}, 
 	plural={momenttiemäfunktiot}, 
 	type=math, 
 	text={momenttiemäfunktio}
} 
...
{name={normaalijakautunut satunnaismuuttuja}, 
	description={A\index{normaalijakautunut satunnaismuuttuja} standard \gls{gaussian} \gls{rv} is a 
		real-valued \gls{rv} $x$ with \gls{pdf} \cite{BertsekasProb}, \cite{papoulis}, \cite{GrayProbBook}
		\begin{equation}
			\nonumber
	...
	firstplural={normaalijakautuneet satunnaismuuttujat}, 
...
{name={todennäköisyysmalli}, 
	description={A probabilistic \gls{model}\index{todennäköisyysmalli} for the 
	...
	plural={todennäköisyysmallit},
	firstplural={todennäköisyysmallit},
	type=math,
	text={todennäköisyysmalli} 
}

\newglossaryentry{mean}
{name={keskiarvo}, plural={keskiarvot},
	description={The\index{keskiarvo} mean of a \gls{rv} $\featurevec$, which takes 
...
{name={varianssi},
	description={The\index{varianssi} variance of a real-valued \gls{rv} $\feature$ is defined 
...
{name={projektio}, 
       	description={Consider\index{projektio} a bounded subset $\paramspace \subseteq \mathbb{R}^{\dimlocalmodel}$ of 
...
{name={Erd\H{o}s–R\'enyi -verkko (ER-verkko)},
	description={An ER \gls{graph}\index{Erd\H{o}s–R\'enyi -verkko (ER-verkko)} \cite{erdds1959random}, \cite{gilbert1959random} is a \gls{probmodel} for \glspl{graph} defined over a given node set $\nodeidx=1, \,\ldots, \,\nrnodes$. One way to define the ER \gls{graph} is via the collection of \gls{iid} binary \glspl{rv} $b^{(\edge{\nodeidx}{\nodeidx'})} \in \{0,1\}$, for each pair of different nodes $\nodeidx, \nodeidx'$. A specific \gls{realization} of an ER \gls{graph} contains an edge $\edge{\nodeidx}{\nodeidx'}$ if and only if $b^{(\edge{\nodeidx}{\nodeidx'})}=1$. The ER \gls{graph} is parameterized by the number $\nrnodes$ of nodes and the \gls{probability} $\prob{b^{(\edge{\nodeidx}{\nodeidx'})}=1}$.\\
		See also: \gls{graph}, \gls{probmodel}, \gls{iid}, \gls{rv}, \gls{realization}, \gls{probability}.},
	first={Erd\H{o}s–R\'enyi -verkko (ER-verkko)},
	type=math, 
	text={ER-verkko}
}
...
{name={lineaarikuvaus}, plural={lineaarikuvaukset}, 
	description={A\index{lineaarikuvaus} linear \gls{map} 
	...
	type=math, 
	plural={lineaarikuvaukset}, 
	firstplural={lineaarikuvaukset}, 
	text={lineaarikuvaus}
}
...
{name={vektoriavaruus},
	...
	plural={vektoriavaruudet}, 
	firstplural={vektoriavaruudet}, 
	type=math,
	text={vektoriavaruus}
}
...
{name={entropia},
	description={Entropy\index{entropia} quantifies the \gls{uncertainty} or 
...
{name={satunnaismuuttuja}, plural={satunnaismuuttujat},
	...
	firstplural={satunnaismuuttuja},
	plural={satunnaismuuttujat},
	type=math,
...
{name={optimointitehtävä}, 
	description={An\index{optimointitehtävä} optimization problem is a mathematical 
		   ...
		   we can determine whether $\mathbf{a} \leq \mathbf{b}$ or not. Here, ``$\leq$'' denotes a 
		   general partial order relation, which may differ from the standard numerical order on 
		   real numbers \cite[Sec. 2.4.]{BoydConvexBook}. 
...
{name={optimointimenetelmä},
	description={An\index{optimointimenetelmä} optimization method is 
...
{name={konveksi optimointi},
 	description={\Gls{convex} optimization\index{konveksi optimointi} studies the 
...
{name={Newtonin menetelmä},
	description={Newton's method\index{Newtonin menetelmä} is an iterative \gls{optmethod} for finding 
...
{name={non-expansive operator},
 	description={An\index{non-expansive operator} \gls{operator} 
       ...
       \end{figure}
		Non-expansiveness is not sufficient to guarantee \gls{convergence} 
...
{name={fixed-point iteration},
	description={A\index{fixed-point iteration} fixed-point \gls{iteration} is an iterative method 
		...
		defined on the 1-D space $\mathbb{R}$. Another example of a firmly \gls{nonexpansiveop} 
		...
		\end{figure} 
		See also: \gls{contractop}, \gls{proxop}.},
...
{name={graph of a function},
 description={Given a \gls{function} $f\!:\!\featurespace \to \labelspace$, 
			  ...
			  defined as
				...
				that is widely used in analysis, topology, and optimization.}, 
	first={graph},
	text={graph},
	type=math, 
	firstplural={graphs},
...
{name={epigrafi},
	description={The epigraph\index{epigrafi} of a real-valued \gls{function} 
	             $f : \mathbb{R}^\nrfeatures \to \mathbb{R} \cup \{+\infty\}$ 
  				 is the set of points lying on or above its \gls{graphoffunction} 
				 (see Fig. \ref{fig_epigraph_dict}), i.e., 
				 \[\operatorname{epi}(f) = \left\{ (\weights, t) \in \mathbb{R}^\nrfeatures \times \mathbb{R} \,\middle|\, f(\mathbf{x}) \leq t \right\}.
				 \]
			...
			\begin{tikzpicture}[scale=1.0]
				...
				\end{axis}
			\end{tikzpicture}
		\caption{Epigraph of the \gls{function} $f(\weight) = \weight^2$ (i.e., 
		the shaded area). \label{fig_epigraph_dict}}
		\end{figure}
		See also: \gls{function}, \gls{convex}.},
	first={epigrafi},
	text={epigrafi},
	type=math, 
	firstplural={epigrafit},
	plural={epigrafit}
}
...
{name={fixed point},
	description={Consider some \gls{operator} $\fixedpointop: \hilbertspace \rightarrow \hilbertspace$ 
				...
				approach for solving various \glspl{optproblem} (e.g., an instance of \gls{erm}). 
...
{name={fixed-point equation},
  description={A fixed-point equation\index{fixed-point equation} is an equation of the form
				...
				minimizer of $f$ \cite{BoydConvexBook}. Similarly, one can reforulate the
...
{name={Lagrangian},
	description={The Lagrangian\index{Lagrangian} of an \gls{optproblem} of %standard
		form 
		\begin{align}
			\min_{\weights \in \mathbb{R}^{\nrfeatures}} & f_0(\weights)   \nonumber \\ 
			\mbox{s.t.} \quad & f_{i}(\weights) \leq 0, \quad i=1,\,\ldots,\,k \\
			& g_j(\weights) = 0, \quad j=1, \,\ldots,\,l
		\end{align}
		is 
		\begin{equation}
			L(\weights, \lambda, \nu) \defeq f_0(\weights) + \sum_{i=1}^{k} \lambda_i f_i(\weights) + \sum_{j=1}^{l} \nu_j g_j(\weights).
		\end{equation}
		The Lagrangian is most often used to formulate the \gls{dual}. \\
		See also: \gls{convexopt}, \gls{optproblem}, \gls{dual}.},
	first={Lagrangian},
	text={Lagrangian},
	plural={Lagrangians},
	type=math
...
{name={Lagrange dual problem},
	description={The Lagrangian\index{Lagrange dual problem} of an \gls{optproblem} of %standard
		form 
		\begin{align}
			\min_{\weights \in \mathbb{R}^{\nrfeatures}} & f_0(\weights)   \nonumber \\ 
			\mbox{s.t.} \quad & f_{i}(\weights) \leq 0, \quad i=1,\,\ldots,\,k \\
		...
		is 
		\begin{align}
			\max_{\lambda \in \mathbb{R}^{k}, \nu \in \mathbb{R}^l} \inf_{\weights \in \mathbb{R}^{\nrfeatures}} & L(\weights, \lambda, \nu) 
			\mbox{s.t.} \quad & \lambda \leq 0,
		\end{align}
		where $L$ is the \gls{lagrangian} of the \gls{optproblem}. \\
		See also: \gls{convexopt}, \gls{optproblem}, \gls{lagrangian}.},
	first={Lagrange dual problem},
	text={dual},
	plural={Lagrange dual problems},
	type=math
	% Todo: add dual feasibility
}
...
{name={kovarianssi}, 
	description={The\index{kovarianssi} covariance between two real-valued 
...
{name={kovarianssimatriisi}, 
	description={The\index{kovarianssimatriisi} \gls{covariance} \gls{matrix} of 
	...
	plural={kovarianssimatriisit},
	firstplural={kovarianssimatriisit},
	type=math, 
...
{name={todennäköisyysjakauma}, 
	...
	plural={todennäköisyysjakaumat},
	firstplural={todennäköisyysjakaumat},
	type=math,
	...
	description={Given a \gls{differentiable} 
	 ...
	 % and, in turn, the resulting \gls{gdmetod} is an instance of a \gls{fixedpointiteration}.
		...
		this \gls{operator} is known as the \gls{proxop} of $f(\cdot)$ \cite{ProximalMethods}. 
					\\ 
		See also: \gls{differentiable}, \gls{gradient}, \gls{stepsize}, \gls{proxop}.},
		...
		the determinant can be interpreted as an oriented area or volume spanned by the column \glspl{vector} of $\mA$.
    		\begin{figure}[H]
    			\begin{center}
					...
					\end{tikzpicture}
				\end{center}
				\caption{We can interpret a square \gls{matrix} $\mA$ as a linear transformation of $\mathbb{R}^{\nrfeatures}$ into itself. The determinant $\det\,(\mA)$ characterizes how this transformation alters an oriented volume.
				\label{fig_det_dict}}
			\end{figure}
...
{name={Hessen matriisi},
 	description={Consider\index{Hessian} a \gls{function} 
		...
		then the Hessian is a symmetric \gls{matrix}, i.e.,
...
{name={denoising autoencoder},
	description={A denoising\index{denoising autoencoder} \gls{autoencoder} extends the basic 
		\gls{autoencoder} by perturbing (e.g., by adding noise to) 
		the \gls{inputvec} (or \gls{featurevec}) before feeding it 
		into the \gls{autoencoder} itself \cite[Sec. 14.2.2]{Goodfellow-et-al-2016}.
...
{name={kaksoisnormi},
	description={Every \gls{norm} $\normgeneric{\cdot}{}$ defined on a \gls{euclidspace} $\mathbb{R}^{\dimlocalmodel}$ 
		has an associated dual \gls{norm}\index{kaksoisnormi}, which is denoted by $\normgeneric{\cdot}{*}$ and defined as 
