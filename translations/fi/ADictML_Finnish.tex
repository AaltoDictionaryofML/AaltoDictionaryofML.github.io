...
\usepackage{tocbibind} 		% Bibliography to ToC
...
\input{ADictML_Regulation_Finnish.tex}
\input{ADictML_MLSystems_Finnish.tex}
\input{ADictML_Math_Finnish.tex}
\input{ADictML_RL_Finnish.tex}
...
%	\resizebox{4cm}{\qrcode{https://github.com/AaltoDictionaryofML/AaltoDictionaryofML.github.io}}\\[10mm]
% TODO: Tämän voisi kirjoittaa paremmin. Myös, muista lisätä nimesi tähän.
{\large	viittaa: A.\ Jung, K.\ Olioumtsevits, E.\ Schnoor, T.\ Ryynänen, J.\ Gronier, S.\ Rastelli ja M. Seesto, \textit{Aallon koneoppimisen sanakirja}. Käännös J.\ Thusberg, H.\ Manninen ja M.\ Seesto. Espoo, Suomi: Aalto Yliopisto, 2026.}
\end{center}
...
\printglossary[type=math,title={Matemaattiset työkalut}, nonumberlist]

\newpage
\printglossary[title={Koneoppimiskäsitteet}, nonumberlist]

\newpage
\printglossary[type=reinflearning, title={Reinforcement Learning}, nonumberlist] % TODO: käännä

\newpage
\printglossary[type=mlsystems, title={Koneoppimisjärjestelmät}, nonumberlist] % TODO: Uusiksi, Machine Learning Systems

\newpage
\printglossary[type=regulation, title={Koneoppimisen säännökset}, nonumberlist] % TODO: Uusiksi, Machine Learning Regulation
