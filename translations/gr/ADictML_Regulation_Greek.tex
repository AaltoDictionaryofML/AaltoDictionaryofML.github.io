...
{name={\foreignlanguage{greek}{γενικός κανονισμός για την προστασία δεδομένων (ΓΚΠΔ)}},
	description={\foreignlanguage{greek}{Ο ΓΚΠΔ}\index{\foreignlanguage{greek}{γενικός κανονισμός για την προστασία δεδομένων (ΓΚΠΔ)}} 
		...
		\begin{itemize}
			...
			\foreignlanguage{greek}{καθώς και να αντιτίθενται στην αυτοματοποιημένη λήψη αποφάσεων και στην} \glsentryuseriii{profiling}. 
		...
		\end{itemize}
		\foreignlanguage{greek}{Βλέπε επίσης:} \gls{data}, \gls{ml}, \gls{dataminprinc}, \gls{transparency}, \gls{explainability}, \gls{profiling}.}, 
