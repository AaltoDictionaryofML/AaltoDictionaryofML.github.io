...
{name={\foreignlanguage{greek}{Ευκλείδεια απόσταση}}, 
	description={\foreignlanguage{greek}{Ο όρος Ευκλείδεια απόσταση}\index{\foreignlanguage{greek}{Ευκλείδεια απόσταση}} 
		(Euclidean distance) \foreignlanguage{greek}{χρησιμοποιείται ως συνώνυμο της} \glsentryuserii{euclidnorm}.	
		\\
		\foreignlanguage{greek}{Βλέπε επίσης:} \gls{euclidnorm}, \gls{vector}, \gls{euclidspace}. },
