...
{name={\foreignlanguage{greek}{ανάλυση} Schur},
	description={TBC.\index{Schur decomposition} },
...
{name={\foreignlanguage{greek}{θετικά ορισμένος}},
	description={A\index{positive definite (pd)} (real-valued)
		\gls{symmetricmatrix} $\mQ = \mQ\,^{T} \in \mathbb{R}^{\featuredim \times \featuredim}$
		is referred to as pd if $\featurevec\,^{T} \mQ \featurevec > 0$
		for every nonzero \gls{vector} $\featurevec \in \mathbb{R}^{\featuredim}$.
		Every pd \gls{matrix} is \gls{psd}, but not vice versa.
		A pd \gls{matrix} $\mQ$ admits a \gls{spectraldecomp} with strictly positive
		\glspl{eigenvalue} $\eigval{1}, \,\ldots, \,\eigval{\featuredim} > 0$
		\cite{HornMatAnalysis}. In particular, a pd \gls{matrix} is \gls{invertible}.
		\\
		Analogously to the \gls{psd} ordering, we write $\mA \succ \mB$
		if $\mA - \mB$ is pd \cite[Sec. 2.4]{BoydConvexBook}.
		\\
		See also: \gls{symmetricmatrix}, \gls{psd}, \gls{invertible}.},
...
{name={\foreignlanguage{greek}{Ιακωβιανός πίνακας}},
	description={TBC.\index{Jacobian matrix} },
...
{name={\foreignlanguage{greek}{περιορισμένο πρόβλημα βελτιστοποίησης}}, 
	description={\foreignlanguage{greek}{Ένα περιορισμένο}\index{\foreignlanguage{greek}{περιορισμένο πρόβλημα βελτιστοποίησης}} 
		\glsentryuseri{optproblem} (constrained optimization problem) \foreignlanguage{greek}{είναι ένα} \glsentryuseri{optproblem} 
		\foreignlanguage{greek}{που περιλαμβάνει περιορισμούς στη μεταβλητή} \glsentryuserii{optimization}. 
		...
		\foreignlanguage{greek}{ανάγεται σε ένα μη περιορισμένο} \glsentryuseriii{optproblem}. 
					\\ 
		\foreignlanguage{greek}{Βλέπε επίσης:} \gls{optproblem}, \gls{optimization}, \gls{objfunc}. }, 
	first={\foreignlanguage{greek}{περιορισμένο πρόβλημα βελτιστοποίησης}}, 
	text={\foreignlanguage{greek}{περιορισμένο πρόβλημα βελτιστοποίησης}},
	type=math,
	user1={\foreignlanguage{greek}{περιορισμένο πρόβλημα βελτιστοποίησης}}, %nominative
  	user2={\foreignlanguage{greek}{περιορισμένου προβλήματος βελτιστο\-ποί\-ησης}}, %genitive 
	user3={\foreignlanguage{greek}{περιορισμένο πρόβλημα βελτιστοποίησης}} %accusative	 
}
