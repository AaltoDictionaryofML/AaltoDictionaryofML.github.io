...
{name={aprendizaje federado vertical (FL vertical)},description=
	{El aprendizaje federado vertical\index{aprendizaje federado vertical (FL vertical)} utiliza conjuntos de datos locales
	formados por los mismos puntos de datos, pero caracterizados mediante diferentes características \cite{VFLChapter}. 
	...
	\\
	Vea también: \gls{localdataset}, \gls{datapoint}, \gls{feature}},
