...
{name={function},
	description={
		  A \textbf{function}\index{function} is a mathematical rule that assigns to each 
		  ...
		  output $f(u) \in \mathcal{V}$ for every input $u \in \mathcal{U}$. For more details, 
	},
	first={function},
	text={function}
}
...
{name={optimization problem},
	description={
		   An\index{optimization problem} optimization problem is a mathematical 
		   ...
		   for which the objective $f(\weights)$ is extremal -- i.e., minimal or maximal \cite{BoydConvexBook,nesterov04,BertsekasNonLinProgr}.
	},
