...
{name=discrepancia,
	description={
		Considere\index{discrepancy} una aplicacion de  \gls{fl} con \gls{netdata} 
...
{name={reducción de dimensionalidad},
	description={
		...
		mapear (normalmente muchos) \gls{feature}s originales a un conjunto (relativamente pequeño) de
