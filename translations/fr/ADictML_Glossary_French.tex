...
\newglossaryentry{mvndist}{name ={loi normale multivariée}, description={The\index{loi normale multivariée} 
		...
		$$p(\featurevec) \propto \exp\bigg(-(1/2) \big( \featurevec - \vm \big)^{T} \mC^{-1} \big( \featurevec - \vm \big) \bigg).$$}, first={loi normale multivariée},text={loi normale multivariée}}
...
{name={mean},
	description={The \index{moyenne} mean of a \gls{rv} $\featurevec$, taking 
...
{name={norme},
	description={A norm\index{norme} is a function that maps each (vector) element 
...
{name={dérivable},
	description={A\index{dérivable} real-valued function $f: \mathbb{R}^{\featuredim} \rightarrow \mathbb{R}$ 
...
{name={variable aléatoire (VA)},
 description={An RV\index{variable aléatoire (VA)} is a function that maps from 
 	...
 	and study the properties of (large) collections of RVs \cite{BillingsleyProbMeasure}.}, first={variable aléatoire (VA)},text={VA}  }
...
\newglossaryentry{covmtx}{name={matrice de covariance}, 
	description={The\index{matrice de covariance} covariance matrix of an \gls{rv} $\vx \in \mathbb{R}^{\featuredim}$ 
...
\newglossaryentry{expectation}{name={espérance}, description={
		Consider\index{espérance} a numeric \gls{featurevec} $\featurevec \in \mathbb{R}^{\featuredim}$ 
		...
		the expectation is only defined if this integral exists, i.e., if the \gls{rv} is integrable.},first={espérance},text={espérance}}
...
\newglossaryentry{probdist}{name={loi de probabilité},
	description={To\index{loi de probabilité} analyze \gls{ml} methods, it can be useful 
	    ...
	    In the most general case, a \gls{probability} distribution is defined by a \gls{probability} measure \cite{GrayProbBook,BillingsleyProbMeasure}.},first={loi de probabilité},text={loi de probabilité}}
...
\newglossaryentry{localdataset}{name={ensemble de données locales},description={The\index{ensemble de données locales} concept of a local \gls{dataset} is 
		...
		are encoded in the edges of an \gls{empgraph}.},first={jensemble de données locales},text={ensemble de données locales}}
