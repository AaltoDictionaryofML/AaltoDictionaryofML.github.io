...
{name={épigraphe},
	description={L’épigraphe\index{épigraphe} d’une fonction à valeurs réelles $f : \mathbb{R}^n \to \mathbb{R} \cup \{+\infty\}$  
		est l’ensemble des points situés sur ou au-dessus de sa courbe :
		\[
		\operatorname{epi}(f) = \left\{ (\mathbf{x}, t) \in \mathbb{R}^n \times \mathbb{R} \,\middle|\, f(\mathbf{x}) \leq t \right\}.
		\]
		Une fonction est \gls{convex} si et seulement si son épigraphe est un ensemble \gls{convex} \cite{BoydConvexBook,BertCvxAnalOpt}.
		\begin{figure}[H]
			\centering
			\begin{tikzpicture}[scale=1.0]
				...
				\end{axis}
			\end{tikzpicture}
			\caption{Épigraphe de la fonction $f(x) = x^2$ (zone grisée).}
		\end{figure}
	},
	first={épigraphe}, text={épigraphe}
}
...
\newglossaryentry{convex}{name={convexe},
	description={A\index{convexe} subset $\mathcal{C} \subseteq \mathbb{R}^{\featuredim}$ of the 
		...
		\end{figure}},first={convexe},text={convexe}}
