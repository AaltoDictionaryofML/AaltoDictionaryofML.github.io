...
\newglossaryentry{mvndist}{name ={loi normale multivariée}, description={The\index{multivariate normal distribution} 
...
\newglossaryentry{overfitting}{name={surapprentissage},description={Consider\index{overfitting} an 
...
\newglossaryentry{erm}{name={minimisation du risque empirique (MRE)}, description={\Gls{emprisk} minimization\index{empirical risk minimization (ERM)} is the optimization problem of finding 
...
\newglossaryentry{learnrate}{name={taux d'apprentissage}, description={Consider\index{learning rate} 
...
\newglossaryentry{fl}{name={apprentissage fédéré}, description={FL\index{federated learning (FL)} 
...
\newglossaryentry{iid}{name={indépendantes et identiquement distribuées (i.i.d.)}, description={It\index{independent and identically distributed (i.i.d.)} can be useful to 
...
\newglossaryentry{kmeans}{name={$k$-moyennes}, description={The\index{$k$-means} $k$-\gls{mean}s \gls{algorithm} 
...
\newglossaryentry{model}{name={modèle}, description={In\index{model} the context of \gls{ml} methods, 
...
\newglossaryentry{clustering}{name={partitionnement de données}, description={Clustering\index{clustering} methods decompose a given 
...
\newglossaryentry{eigenvalue}{name={valeur propre}, description={We\index{eigenvalue} refer to a 
...
\newglossaryentry{eigenvector}{name={vecteur propre}, description={An\index{eigenvector} 
...
\newglossaryentry{pca}{name={analyse en composantes principales (ACP)}, description={PCA\index{principal component analysis (PCA)} 
...
\newglossaryentry{lossfunc}{name={fonction de perte (ou de coût)}, description={A\index{loss function} \gls{loss} function is a map 
...
{name=forêt aléatoire,
	description={A\index{random forest} random forest is a set (or ensemble) of different \gls{decisiontree}s. 
		...
		the original \gls{dataset}.},first = {forêt aléatoire}, text={forêt aléatoire}
}
...
\newglossaryentry{gd}{name={descente de gradient (GD)},description={\Gls{gradient}\index{gradient descent (GD)} 
...
\newglossaryentry{llm}{name={modèle de langage de grande taille},description={
	...
	large \gls{trainset}s for large language \gls{model}s.},
					first={modèle de langage de grande taille},text={modèle de langage de grande taille}}
...
\newglossaryentry{smooth}{name={lisse)},
