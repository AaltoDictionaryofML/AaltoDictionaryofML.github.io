...
\newglossaryentry{onlinelearning}
{
	...
	description={Certaines méthodes d’\gls{ml} \index{apprentissage en ligne} sont conçues pour traiter les \glspl{datapoint} 
...
\newglossaryentry{llm}{name={grand modèle de langage (GML)},description={
	...
	use \gls{deepnet}s with billions (or even trillions) of \gls{parameter}. 
