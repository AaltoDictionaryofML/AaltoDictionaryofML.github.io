...
\begin{align}
	...
	&\nodeidx \in \nodes & \quad & \parbox{.75\textwidth}{
		Un nœud représentant un \gls{device} dans un \gls{empgraph}. Le \gls{device} peut accéder à un \gls{localdataset} et entraîner un \gls{localmodel}. \\
