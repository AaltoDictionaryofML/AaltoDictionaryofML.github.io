...
\newglossaryentry{hfl}
{name={federated learning orizzontale (FL orizzontale))},description=
	{\gls{fl} Orizzontale \index{federated learning orizzontale (FL orizzontale)} utilizza \gls{localdataset} costituiti da
...
{name={riduzione della dimensionalità},
	description={Le tecniche di riduzione della dimensionalità\index{dimensionality reduction} methods 
		mappano (tipicamente molte) \gls{feature} grezze in un insieme (relativamente piccolo) di  
		nuove \gls{feature}. Questi metodi possono essere utilizzati per visualizzare 
		i \gls{datapoint} apprendendo due \gls{feature} che possono essere impiegate come 
		coordinate per una rappresentazione in uno \gls{scatterplot}.}, first={riduzione della dimensionalità},text={riduzione della dimensionalità}
} 
...
\newglossaryentry{probdist}{name={probability distribution},
	description={To\index{probability distribution} analyze \gls{ml} methods, it can be useful 
	    ...
	    In the most general case, a \gls{probability} distribution is defined by a \gls{probability} 
		measure \cite{GrayProbBook,BillingsleyProbMeasure}.},
