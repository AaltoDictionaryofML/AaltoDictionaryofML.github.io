...
{name={realizzazione}, plural={realizzazioni},
	...
	$x(\omega') = a'$ per qualche $\omega' \in \mathcal{P}$.
			\\
		Si veda anche: \gls{rv}, \gls{probspace}.}, first={realizzazione},text={realizzazione}  }
...
\newglossaryentry{expectation}{name={valore atteso}, plural={valori attesi}, description={
...
\newglossaryentry{model}{name={modello}, plural={modelli}, description={Nel\index{modello} contesto dei metodi di \gls{ml}, 
		il termine modello si riferisce tipicamente allo \gls{hypospace} alla base di un metodo di 
		\gls{ml} \cite{ShalevMLBook,MLBasics}. Tuttavia, il termine è usato anche in altri ambiti, 
		ma con un significato diverso. Per esempio, un \gls{probmodel} si riferisce ad un insieme parametrizzato di \glspl{probdist}.},
		first={modello},text={modello} }
