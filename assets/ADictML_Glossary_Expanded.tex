...
{name={metric},
	description={In its most general form, a metric is a quantitative measure used to compare or evaluate objects. 
		...
		triangle inequality \cite{RudinBookPrinciplesMatheAnalysis}. In machine learning (ML), a metric is a quantitative measure 
		of how well a model performs. Examples include accuracy, precision, and the average $\bf 0/1$ loss 
