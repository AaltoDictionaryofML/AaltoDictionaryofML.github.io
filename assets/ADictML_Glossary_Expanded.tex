...
\newglossaryentry{em}{name={expectation-maximization (EM)}, description={
		...
		random variable (RV) ${\bf z}$ such that maximizing $p({\mathcal{D},{\bf z}; {\bf w}})$ would be easier \cite{hastie01statisticallearning}, \cite{BishopBook}, \cite{GraphModExpFamVarInfWainJor}. Since we 
