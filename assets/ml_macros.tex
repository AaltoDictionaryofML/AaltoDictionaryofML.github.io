...
\newcommand{\covmtxgeneric}{{\bf \Sigma}} 
...
\newcommand{\clustercentroid}[1]{{\bm \mu}^{(#1)}} 
...
\newcommand{\action}{a}    % careful when using this macros file for beamer slides, as \action is already used by beamer
