...
{name={artificial intelligence system (AI system)},
 description={A computational\index{AI system} system designed to operate with a degree 
              of autonomy by processing \gls{data} and producing 
              \glspl{prediction} that can, via informing decisions, 
              influence physical or virtual environments. 
              An \gls{ai} system typically comprises multiple components, 
              including \glspl{optmethod}, \glspl{model}, \glspl{dataset}, 
              computing infrastructure, and procedures for deployment, 
              monitoring, and human interaction. In the EU Artificial Intelligence Act, 
              an \gls{ai} system is defined as a machine-based system that is 
              designed to operate with varying levels of autonomy and that may 
              exhibit adaptiveness after deployment, producing outputs that 
              ...
              models or algorithms. From a machine learning perspective, the system-level 
              view emphasizes that properties such as robustness, fairness, transparency, 
              and safety emerge from the interaction of models, data, and operational 
              context rather than from isolated learning components.
},
...
{name={deepfake},
 description={Synthetic\index{deepfake} media generated or substantially modified by an 
             \gls{aisystem} such that it falsely appears to depict a real person, 
             object, or \gls{event}. Deepfakes are typically produced using 
