...
{name={structural causal model (SCM)},
 description={A SCM \index{structural causal model (SCM)} 
    is a mathematical model of cause–effect relationships within 
