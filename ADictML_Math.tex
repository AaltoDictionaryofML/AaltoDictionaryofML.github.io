...
{name={vector space},
	description={A\index{vector space} \gls{vector} space $\mathcal{V}$ (also called linear space) 
		...
		\\
		See also: \gls{vector}, \gls{basis}, \gls{euclidspace}, \gls{hilbertspace}, \gls{linmodel}, \gls{linearmap}.},
	first={vector space},
...
{name={boundary},
   description={Consider\index{boundary} a subset $\mathcal{C} \subseteq \mathbb{R}^n$. 
                ...
                \begin{figure}
					 ...
					 \end{tikzpicture}
                      \caption{Boundary of set $\mathcal{C}$ and a closed ball $\closedball{\vx}{\varepsilon}$ around 
				            $\vx\!\in\!\bd{\mathcal{C}}$.}
                \end{figure}
					...
					an \gls{undirectedgraph} with \gls{metric} given by the length of the shortest path.},
