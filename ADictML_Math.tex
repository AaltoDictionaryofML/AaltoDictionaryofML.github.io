...
{name={boundary},
   description={Consider\index{boundary} a subset $\mathcal{C} \subseteq \mathbb{R}^n$. The boundary 
   	                        of $\mathcal{C}$, denoted by $\bd{\mathcal{C}}$, is the set of all points 
   	                         $\vx \in \mathbb{R}^n$ such that every open ball centred at $\vx$ intersects 
   	                         both $\mathcal{C}$ and its complement $\mathbb{R}^n \setminus \mathcal{C}$.},
   	 first ={boundary}, 
   	 type=math,
   	 text={boundary}
}
