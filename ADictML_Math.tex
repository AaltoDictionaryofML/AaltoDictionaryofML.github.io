...
{name={spectrum},
 description={The spectrum\index{spectrum} of a linear \gls{operator} $\fixedpointop$ 
			  ...
			  object for an which an associated linear \gls{operator} can be defined. 
			  For example, the spectrum of a square \gls{matrix} $\mA \in \mathbb{R}^{\dimlocalmodel \times \dimlocalmodel}$ 
  			  is obtained via the spectrum of the associated linear \gls{operator} \cite{HornJohnson}.
