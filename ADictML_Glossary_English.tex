...
{name={application programming interface (API)},
		description={
			...
			model remains hidden from the user. For instance, consider a trained \gls{ml} model  
			...
			without knowledge of the detailed structure of the \gls{ml} model or its training. 
			In practice, the \gls{ml} model is typically hosted on a computer (i.e., a server) connected to the internet. 
