...
{name=differential privacy (DP),
  description={
  	Consider\index{differential privacy} some ML method $\algomap$ that reads in a \gls{dataset} (e.g., the \gls{trainset} 
...
{name={baseline},
    description={Consider\index{baseline} some ML method that produces a learned 
...
\newglossaryentry{model}{name={model}, description={In\index{model} the context of ML methods, 
...
\newglossaryentry{ai}{name={artificial intelligence}, description={
		...
		environment. The choice of \gls{lossfunc}sets AI applications apart from more basic ML applications. 
...
\newglossaryentry{llm}{name={Large Language Model},description={
	Large Language Models (LLMs)\index{large language model (LLM)} is an umbrella term for ML methods 
...
\newglossaryentry{paramspace}{name={parameter space},
		...
		\gls{modelparams} (see Figure \ref{fig_param_space_dict}). Many important ML methods 
...
\newglossaryentry{datanorm}{name={data normalization},
		description={Data normalization\index{data normalization} refers to transformations 
			...
			\gls{statasp} or \gls{compasp} of the overall ML method. For instance, in \gls{linreg} 
