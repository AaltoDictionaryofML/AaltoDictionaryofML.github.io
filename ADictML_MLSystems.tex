...
{name={staleness},
	description={In a distributed \gls{mlsystem} (e.g., an \gls{flsystem}), staleness\index{staleness} refers to 
				 ...
				 copy of \glspl{modelparam} are outdated \cite{JungFLBook,ParallelDistrBook,Coulouris2012}. 
		...
		\\
		See also: \gls{distributedalgorithm}, \gls{flsystem}. },
	first={staleness},
	type=mlsystems,
	text={staleness}
}
