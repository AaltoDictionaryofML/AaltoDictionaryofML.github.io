...
{name={automaton},
 description={An\index{automaton} automaton is a mathematical representation of a computing \gls{device} 
              ...
              Collections of interacting automata can be used to model \gls{distributedalgorithm}, 
			  where each automaton represents a computational node reacting to local 
 			  events and communicated information \cite{LynchDistributedAlgorithms,ParallelDistrBook}.}, 
  first = {automaton}, 
  type=mlsystems,
  plural ={automata}, 
  text = {automaton} 
