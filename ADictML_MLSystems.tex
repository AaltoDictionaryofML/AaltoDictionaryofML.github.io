...
{name={longitudinal data},
 description={Longitudinal \gls{data}\index{longitudinal data} consists of \glspl{datapoint} 
...
{name={cross-sectional data},
 description={Cross-sectional \gls{data}\index{cross-sectional data} consists of 
              \glspl{datapoint} whose attributes are measured once, without explicitly 
			  modeling temporal evolution \cite{Wooldridge2013}. In \gls{ml}, 
			  cross-sectional \gls{data} arise image classification, 
 ...
 firstplural={cross-sectional data},
 type=mlsystems,
