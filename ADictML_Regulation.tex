...
{name={profiling},
	description={Profiling\index{profiling} aims at identifying patterns and make inferences about 
		...
		Profiling techniques use \gls{ml} methods to predict 
		individuals' performance at work, economic situation, health, personal preferences, 
		...
		and personalized services. The \gls{gdpr} impose strict requirements 
