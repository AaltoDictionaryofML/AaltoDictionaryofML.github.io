...
{name={personal data},
	description={Personal \gls{data} are any information\index{personal data} 
		...
		In \gls{ml} systems, personal \gls{data} may occur in \gls{training} \gls{data}, 
...
{name={automated decision-making},
 	   description={\Gls{ml} applications that use \glspl{prediction} delivered 
	                 by a trained \gls{model} directly (without human involvement) 
