...
{name={provider (AI Act)},
	description={The\index{provider (AI Act)} EU Artificial Intelligence Act
		(AI Act) defines a provider as a natural or legal person, public
		...
		\\
		See also: \gls{aisystem}, \gls{mlaas}, \gls{apiendpoint}, \gls{model}.},
	first={provider},
	plural={providers},
